...
using DAL;
using QuickStockInfo.ViewModels;
using AutoMapper;
using DAL.Models;
using Microsoft.Extensions.Logging;
using QuickStockInfo.Helpers;
using Microsoft.Extensions.Options;

namespace QuickStockInfo.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        {
            string recepientName = "QuickStockInfo Tester"; //         <===== Put the recepient's name here
            string recepientEmail = "kkdubey12@gmail.com"; //   <===== Put the recepient's email here

            string message = EmailTemplates.GetTestEmail(recepientName, DateTime.UtcNow);

            (bool success, string errorMsg) response = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from QuickStockInfo", message);
